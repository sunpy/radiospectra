...
@mock.patch("radiospectra.spectrogram.spectrogram_factory.parse_path")
def test_callisto_hour_rollover(parse_path_moc):
    start_time = Time("2011-06-07 23:45:06.000")
    meta = {
        "fits_meta": {
            "OBS_LAC": "N",
            "OBS_LAT": 53.0941390991211,
        ...
        "instrument": "e-CALLISTO",
        "observatory": "BIR",
        "start_time": Time("2011-06-07 23:46:06.000"),
        "end_time": Time("2011-06-08 24:01:06.000"),
        "wavelength": a.Wavelength(20000.0 * u.kHz, 91813.00 * u.kHz),
        "times": start_time + np.arange(3600) * 0.25 * u.s,
        "freqs": [
            91.81300354003906,
