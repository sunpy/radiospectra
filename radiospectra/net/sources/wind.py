...
class WAVESClient(GenericClient):
    ...
    baseurl = (r'https://solar-radio.gsfc.nasa.gov/data/wind/{Wavelength}/{year}/{Wavelength}/'
               r'(\d){{8}}.{ext}')
    ...
    def post_search_hook(self, exdict, matchdict):
        """
        This method converts 'rad1' and 'rad1' in the url's metadata to the frequency ranges of
        for low and high frequency receivers and removes the ext.
        """
    ...
    def register_values(cls):
        adict = {a.Instrument: [('WAVES', 'WIND - Waves')],
                 a.Source: [('WIND', 'WIND')],
